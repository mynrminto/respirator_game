  ...
  var SCENES = [
    ...
    /* ===================== プロローグ ===================== */
    {
      ...
      lines: [
        ...
        { who: 'scene', bg: 'picu', say: '奥のベッドには、肺炎で両肺が真っ白になった 3 歳の女の子。隣には、RSV で入院した生後 4 か月の男の子。' },
        { who: 'doc', say: '覚えることは多いけれど、根っこは 1 つ。この機械が何を保証して、何をこの子に預けているか。' },
        { who: 'nurse', say: 'いぶき先生、手術室から電話です。' },
        { who: 'doc', mood: 'think', say: '…はい。…分かりました。ベッドを空けて待っています。' },
        { who: 'doc', say: '虫垂炎の穿孔で手術になった 8 歳の男の子が、挿管されたまま今夜ここへ来ます。ハルト君です。' },
    ...
    /* ===================== 第1章 ===================== */
    {
      ...
      lines: [
        ...
        { who: 'nurse', say: '呼吸器、つながりました。設定は麻酔科の先生が入れてくれています。' },
    ...
    /* ===================== 第2章 ===================== */
    {
      ...
      bg: 'picu',
      lines: [
        { who: 'scene', say: '翌朝 8 時。回診の前に、夜勤の看護師から申し送りを受ける。' },
    ...
    },
    {
      ...
      lines: [
        ...
        { who: 'doc', say: '今夜はもう一度、当直です。次は機械の外から答え合わせをします。血液ガスです。' }
      ]
    },

    /* ===================== 第4章 ===================== */
    {
      id: 'ch4-open', kind: 'open', chapter: 'ch4', title: '第4章　扉　2 回目の当直',
      card: { kicker: '第4章', title: '血液ガスを読む', sub: '2 日目の夜　当直' },
      bg: 'station',
      lines: [
        { who: 'scene', say: '2 回目の当直。日付が変わるころ、ナースステーションに採血の結果が並びはじめる。' },
    ...
    {
      id: 'ch4-close', kind: 'close', chapter: 'ch4', title: '第4章　幕　明け方',
      bg: 'dawn',
      lines: [
        { who: 'scene', say: '明け方。ミオちゃんの pH は低めのまま。それでも、肺にかかる圧は上限の下に収まった。' },
        { who: 'me', say: 'CO₂ が高いままでいいのか、まだ少し怖いです。' },
        { who: 'doc', say: 'その怖さは大事にしてください。許すのは、肺を守るという目的があるときだけです。' },
        { who: 'fam', name: 'ミオちゃんのお母さん', say: '先生たち、ひと晩じゅう、そばにいてくださったんですね。' },
        { who: 'doc', mood: 'think', say: '次の当直では、鳴ってからの動き方を体に入れます。アラームは待ってくれません。' }
      ]
    },

    /* ===================== 第5章 ===================== */
    {
      id: 'ch5-open', kind: 'open', chapter: 'ch5', title: '第5章　扉　3 回目の当直',
      card: { kicker: '第5章', title: 'アラームとトラブル', sub: '3 日目の夜　当直' },
      bg: 'station',
      lines: [
        { who: 'scene', say: '3 回目の当直。ナースステーションで、ななみさんが {名前}先生に声をかけた。' },
    ...
    /* ===================== 第6章 ===================== */
    {
      id: 'ch6-open', kind: 'open', chapter: 'ch6', title: '第6章　扉　数日後',
      card: { kicker: '第6章', title: '離脱と抜管', sub: '数日後の朝　PICU' },
      bg: 'picu',
      lines: [
        { who: 'scene', say: '数日後の朝。ハルト君の熱は下がり、胸のドレーンも抜けた。お母さんが面会に来ている。' },
    ...
    /* ===================== エピローグ ===================== */
    {
      ...
      lines: [
        { who: 'scene', say: 'ローテーション最終日。夕方の PICU で、また新しい入院の電話が鳴っている。' },
