    ...
    lessons: [

      {
        ...
        tasks: [
          {
            talk: true, who: 'scene',
            say: 'ハルト君（8歳）が PICU のベッドに落ち着いた。虫垂炎の手術を終え、挿管されたままだ。'
          },
          {
            talk: true, who: 'doc',
          ...
          },
          {
            ...
            quiz: {
              ...
              answer: 1,
              miss: ['気道内圧は PEEP より下がりません。ずっとゼロより上です。', null,
    ...
    lessons: [

      {
        ...
        tasks: [
          {
            talk: true, who: 'scene',
            say: '深夜 1 時。ハルト君の定時の採血。いぶき先生が、結果の読み方を教えてくれるという。'
          },
          {
            talk: true, who: 'doc',
        ...
        tasks: [
          ...
          },
          {
            ...
            why: '吸引のあいだは換気が止まり、陰圧で肺胞も潰れるので、SpO₂ が一時的に下がりました。'
              + '先に 100% で貯金しておいたぶん、落ち込みは小さく、すぐ戻ります。新生児では徐脈も起こるので心拍も一緒に見ます。'
          }
        ]
      },
    ...
    lessons: [
...

      {
        ...
        tasks: [
          {
            talk: true, who: 'scene',
            say: '翌朝。ハルト君の鎮静は切ってある。しっかり目を開け、自分で呼吸している。今日は抜管を目指す。'
          },
          {
            talk: true, who: 'doc',
