...
public enum ScenarioLibrary {
    ...
    public static let postoperative = Scenario(
        ...
        history: "8歳 男児、体重 25 kg、身長 126 cm。穿孔性虫垂炎による汎発性腹膜炎と敗血症性ショックで緊急開腹術。術中から大量輸液とノルアドレナリンを要し、腸管浮腫でお腹も張っている。循環が落ち着くまで人工呼吸を続ける方針で、挿管のまま PICU に入室した。鎮静中で、自発呼吸はほとんどない。胸部X線は両下肺にわずかな無気肺があるのみ。",
        findings: ["体温 37.2℃", "心拍 100 /分", "血圧 96/58 mmHg（平均 68、ノルアドレナリン 0.1 μg/kg/分）",
    ...
    public static let bronchiolitis = Scenario(
        ...
        history: "生後 4か月、体重 6.0 kg。4日前から鼻汁と咳。2日前に哺乳不良で入院し、高流量鼻カニュラを開始した。陥没呼吸が強まり、無呼吸発作も出たため気管挿管。RSV 抗原陽性。胸部X線は過膨張と右中葉の無気肺。",
    ...
    public static let guillainBarre = Scenario(
        ...
        history: "7歳 女児、体重 22 kg、身長 120 cm。感冒の 2週間後から歩けなくなり、下肢から上行する筋力低下。肺活量が低下し CO2 が溜まってきたため気管挿管し、免疫グロブリン大量療法を行った。挿管から 16 日目。手足は少しずつ動くようになってきたが、まだ力は弱い。肺そのものに病変はなく、胸部X線は正常。",
