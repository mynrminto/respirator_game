...
extension LessonLibrary {
    ...
    static let lesson4_3 = Lesson(
        ...
        tasks: [
            .talk(.scene, "夜中に血圧が下がり、ミオちゃんの PEEP は 5 まで下げられていた。輸液で血圧は戻ったが、FiO₂ {FiO₂}% でも SpO₂ は {SpO₂}% までしか上がらない。"),
    ...
    static let lesson4_4 = Lesson(
        ...
        tasks: [
            .talk(.scene, "昼。ミオちゃんの CO₂ が上がってきたため、一回換気量が 130 mL（9 mL/kg）に増やされていた。"),
    ...
    static let lesson5_2 = Lesson(
        ...
        points: ["auto-PEEP は吐き残しの圧",
                 ...
                 "対策の第一は呼吸回数を下げること"],
        tasks: [
            .talk(.scene, "RSV のそうた君（生後 4 か月）。鼻カニュラで持ちこたえられず、夕方に挿管された。CO₂ が高くて呼吸回数を上げたら、血圧が下がってきた。"),
    ...
    static let lesson6_2 = Lesson(
        ...
        tasks: [
            .talk(.scene, "ギラン・バレーのあかりちゃん（7歳）。挿管から 16 日目。手足は動きはじめた。肺はきれい。でも、呼吸の筋肉はまだ弱い。"),
