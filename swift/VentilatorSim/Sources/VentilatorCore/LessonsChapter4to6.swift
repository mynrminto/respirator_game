...
extension LessonLibrary {
    ...
    static let lesson4_4 = Lesson(
        ...
        tasks: [
            ...
            .step("いまの Vte（mL/kg）と Pplat を確かめてください。",
                ...
                .explaining { c in
                    String(format: "Vte %.1f mL/kg。肺保護の枠をはみ出しています。", c.tidalPerKg)
                }
    ...
    static let lesson5_1 = Lesson(
        ...
        tasks: [
            ...
            .key("患者が痰を貯めました。設定を変える前に、何をしますか。",
            ...
            .quiz("この所見から考えられるのはどれですか。",
                  ["肺が硬くなった",
                   ...
                   "PEEP が高すぎる",
                   "回路のリーク"], answer: 1,
                  why: "差が開いた＝抵抗の増加で、Raw も上がっています。痰、屈曲、咬み込み、気管支攣縮を順に確認。小児は体位を変えただけでチューブが折れたり深く入ったりするので、直前に何をしたかを必ず確かめます。"),
            ...
            .step("SpO₂ の動きを 30 秒見てください。", hold: 30,
                  why: "吸引の直後は陰圧で肺胞が虚脱するため、SpO₂ が一時的に下がって数分で戻ります。慌てて FiO₂ を上げたままにしないこと。新生児では徐脈も起こるので心拍も一緒に見ます。",
                  check: { _ in true })
        ...
        tasks: [
            ...
            .quiz("この所見に加えて、左の呼吸音が聞こえません。何を疑いますか。",
                  ["右片肺挿管または気胸",
                   ...
                   "回路のリーク",
                   "鎮静が浅い"], answer: 0,
                  why: "チューブは右主気管支に入りやすいので、消えるのは左が多くなります。小児では体位変換やケアのあとに起こり、0.5〜1 cm 引き抜けば戻ります。緊張性気胸なら血圧も下がります。"),
            .step("胸腔ドレーンが入りました。SpO₂ と圧が戻るのを 40 秒見てください。",
                  hold: 40,
    ...
    static let lesson6_2 = Lesson(
        ...
        tasks: [
            ...
            .quiz("SBT 開始から 20 分かけて、じわじわ RR が上がり Vte が落ちてきました。これは何ですか。",
                  ["正常な適応",
                   "呼吸筋疲労のサイン",
                   "鎮静が効いてきた",
                   "回路のリーク"], answer: 1,
